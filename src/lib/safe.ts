/**
 * This function will try and catch a passed in function, and return either the result or the error depending on if the function succeeds.
 * @template T
 * @template E
...
/**
 * This function will try and catch a passed in async function, and return either the result or the error depending on if the function succeeds.
 * @template T
 * @template E
